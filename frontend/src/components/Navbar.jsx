      ...
      <div className="container px-4 py-3 mx-auto">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {isAdmin && (
              <Link className="flex items-center px-3 py-1 font-medium text-white transition duration-300 ease-in-out rounded-md bg-emerald-700 hover:bg-emerald-600">
            ...
            {user ? (
              <button className="flex items-center px-4 py-2 text-white transition duration-300 ease-in-out bg-gray-700 rounded-md hover:bg-gray-600">
                <LogOut size={18} />
